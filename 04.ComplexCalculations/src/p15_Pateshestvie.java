...
public class p15_Pateshestvie {
    public static void main(String[] args) {
        ...
        if (biudjet > 101 && biudjet <= 1000 && sezon.equals("summer")){
            ...
            System.out.printf("Somewhere in %s %n%s - %.2f",destinaciq,vidPochivka,poharchenaSuma);
        } else if (biudjet > 101 && biudjet <= 1000 && sezon.equals("winter")){
            String destinaciq = "Balkans";
            String vidPochivka = "Hotel";
            double poharchenaSuma = balkaniZima;
            System.out.printf("Somewhere in %s %n%s - %.2f",destinaciq,vidPochivka,poharchenaSuma);
        }
        if (biudjet > 1000 && sezon.equals("summer")){
            String destinaciq = "Europe";
            String vidPochivka = "Hotel";
            double poharchenaSuma = evropa;
            System.out.printf("Somewhere in %s %n%s - %.2f",destinaciq,vidPochivka,poharchenaSuma);
        }
    }
}